...
// editPostButton.addEventListener("click", () => {
  ...
  document.getElementById("pfpImg").src = `https://robohash.org/${name}`;
...
//       const insideHtml = `<div class="container2">
//       <div class="card-main">
//         <div class="profilePic"><img class="pfpp" src="https://robohash.org/${name}" alt="" /></div>
//       </div>
//       <div class="card2">
